...
class NewsletterGenUI:
    ...
    def sidebar(self):
        with st.sidebar:
            ...
            st.write(
                """
                To create a newsletter, simply provide a topic and a personal message.\n
                Our team of AI agents will handle the rest and generate the newsletter for you!
                """
            )

            st.text_input("Topic", key="topic", placeholder="Olympic Games Paris 2024")

            st.text_area(
                "Enter a message that will be included at the top of the newsletter.",
    ...
    def render(self):
        st.set_page_config(page_title="Newsletter Creation", page_icon="📧")
